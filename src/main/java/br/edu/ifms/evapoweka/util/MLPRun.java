...
public class MLPRun {
    ...
    public Evaluation evaluate(Instances train, Instances test, AbstractOutput classificationOutput) {
        try {
            mlp.buildClassifier(train);

            Evaluation eval = new Evaluation(train);
            if (classificationOutput instanceof AbstractOutput) {
                eval.evaluateModel(mlp, test, classificationOutput);
            } else {
